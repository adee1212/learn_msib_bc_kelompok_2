...
workChain.addBlock(new block(Date.now().toString(),["HALO INI BLOCK PERTAMA"]));
workChain.addBlock(new block(Date.now().toString(),["HALO INI BLOCK KEDUA"]));
workChain.addBlock(new block(Date.now().toString(),["HALO INI BLOCK KETIGA"]));
